<<<<<<< HEAD:student_managaement_system/src/com/sms/payment/validator/PaymentValidator.java
        ...
        while (true) {
            try {
                ...
                if (!expiry.matches("(0[1-9]|1[0-2])/\\d{2}")) {
                    throw new AppException("❌ Invalid expiry date! Must be in MM/YY format (e.g., 12/25).\nPlease try again:");
                }
                // Basic expiry validation: check if date is not in the past
...
>>>>>>> 71173d7d61301de96b6b01c5c65b9d662b34cace:Student-Management-System/student-management-system/student_managaement_system/src/com/sms/payment/validator/PaymentValidator.java
}