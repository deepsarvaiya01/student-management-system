...
public class SubjectAnalysisService {
	...
	public void displayMandatorySubjectsCount() throws SQLException {
		...
		for (String subjectName : mandatorySubjects.keySet()) {
			System.out.printf("│ • %-65s │%n", subjectName);
		}
	...
	public void displayMostAssignedSubjects() throws SQLException {
		...
		for (Map.Entry<String, Integer> entry : assignedSubjects.entrySet()) {
			...
			System.out.printf("│ %-23s │ %-15d │ %-15.1f%% │%n", 
				subjectName, assignmentCount, percentage);
		}
	...
	public void displayAssignmentEfficiency() throws SQLException {
		...
		System.out.println("├─────────────────────────────────────────────────────────────────────────────┤");
		System.out.printf("│ Total Subjects: %-55d │%n", totalSubjects);
		System.out.printf("│ Assigned Subjects: %-52d │%n", assignedSubjects);
		System.out.printf("│ Unassigned Subjects: %-50d │%n", unassignedSubjects);
		System.out.printf("│ Subject Assignment Rate: %-45.1f%% │%n", subjectAssignmentRate);
		System.out.println("├─────────────────────────────────────────────────────────────────────────────┤");
		System.out.printf("│ Total Teachers: %-54d │%n", totalTeachers);
		System.out.printf("│ Teachers with Subjects: %-47d │%n", teachersWithSubjects);
		System.out.printf("│ Teacher Utilization Rate: %-44.1f%% │%n", teacherUtilizationRate);
		System.out.println("└─────────────────────────────────────────────────────────────────────────────┘");
	}
	...
	public void displaySubjectEnrollmentByCourse() throws SQLException {
		...
		for (Map.Entry<String, Map<String, Integer>> courseEntry : subjectEnrollmentByCourse.entrySet()) {
			...
			System.out.println("├─────────────────────────┬─────────────────────────────────────────────────┤");
			System.out.println("│ Subject Name            │ Enrollment Count                               │");
			System.out.println("├─────────────────────────┼─────────────────────────────────────────────────┤");
			...
			for (Map.Entry<String, Integer> subjectEntry : subjects.entrySet()) {
				...
				System.out.printf("│ %-23s │ %-47d │%n", 
					subjectName, enrollmentCount);
			}
	...
	public void displaySubjectWiseStudentCount() throws SQLException {
		...
		for (Map.Entry<String, Integer> entry : subjectStudentCount.entrySet()) {
			...
			System.out.printf("│ %-23s │ %-15d │ %-15.1f%% │%n", 
				subjectName, studentCount, percentage);
		}
	...
	public void displaySubjectCompletionRates() throws SQLException {
		...
		System.out.println("\n┌─────────────────────────┬─────────────────┬─────────────────┬─────────────────┬─────────────────┐");
		System.out.println("│ Subject Name            │ Total Enrolled  │ Completed       │ In Progress     │ Completion %    │");
		System.out.println("├─────────────────────────┼─────────────────┼─────────────────┼─────────────────┼─────────────────┤");
		...
		for (Map.Entry<String, Object> entry : subjectCompletionRates.entrySet()) {
			...
			System.out.printf("│ %-23s │ %-15d │ %-15d │ %-15d │ %-15.1f%% │%n", 
				subjectName, totalEnrolled, completed, inProgress, completionRate);
		}
